...
import {
  CreditCard, Calendar, ClipboardCheck, FolderOpen, FileSearch, Fuel,
  BookOpen, UserCircle, Search, ShieldCheck,
} from "lucide-react";
...
const DriverCompliance = () => {
  ...
  const renderContent = () => {
      ...
      return (
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
          ...
          <p className="text-sm text-muted-foreground max-w-sm">
            Choose a driver from the selector above to view their {currentTab?.label.toLowerCase()} data.
          </p>
        </motion.div>
      );
    }
    ...
    const map: Record<string, JSX.Element> = {
      ...
      calendar: <DriverComplianceCalendar />,
