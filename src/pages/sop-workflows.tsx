...
import {
  ...
  fleetTransferConfig, fuelRequestConfig, vehicleRequestConfig,
...
export const FuelRequestPage              = wrap(fuelRequestConfig);
export const VehicleRequestSopPage        = wrap(vehicleRequestConfig);
