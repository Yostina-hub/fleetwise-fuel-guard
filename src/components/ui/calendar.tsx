  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: cn(
          "h-8 rounded-md border border-border/60 pl-2.5 pr-7 text-sm font-medium text-foreground",
          ...
          "bg-transparent",
          "bg-[url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2210%22 height=%2210%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22white%22 stroke-width=%222.5%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22 opacity=%220.6%22><polyline points=%226 9 12 15 18 9%22/></svg>')] bg-no-repeat bg-[right_0.5rem_center]",
        ),
