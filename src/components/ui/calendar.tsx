  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: cn(
          "h-8 rounded-md border border-border/60 bg-transparent pl-2.5 pr-7 text-sm font-medium text-foreground",
          "hover:bg-accent/50 hover:border-border focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-0",
          "appearance-none cursor-pointer transition-colors",
          "[&>option]:bg-popover [&>option]:text-popover-foreground",
          "bg-[url('data:image/svg+xml;utf8,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%2210%22 height=%2210%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22currentColor%22 stroke-width=%222.5%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22 opacity=%220.6%22><polyline points=%226 9 12 15 18 9%22/></svg>')] bg-no-repeat bg-[right_0.5rem_center]",
        ),
