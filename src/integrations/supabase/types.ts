...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      shared_ride_passengers: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "shared_ride_passengers_vehicle_request_id_fkey"
            columns: ["vehicle_request_id"]
            isOneToOne: false
            referencedRelation: "vehicle_requests"
            referencedColumns: ["id"]
      ...
      shared_rides: {
        Row: {
          ...
          created_at: string
          created_by: string | null
          cross_pool_allowed: boolean
          departure_at: string
          destination_geom: unknown
          destination_label: string
          destination_lat: number
          destination_lng: number
          driver_id: string | null
          flexibility_buffer_min: number
          id: string
          notes: string | null
          organization_id: string
          origin_geom: unknown
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "shared_rides_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "shared_rides_vehicle_id_fkey"
            columns: ["vehicle_id"]
            isOneToOne: false
            referencedRelation: "vehicles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      can_manage_shared_ride: {
        Args: { _pool_code: string; _ride_org: string }
        Returns: boolean
      }
      can_see_shared_ride: {
        Args: { _pool_code: string; _ride_org: string }
