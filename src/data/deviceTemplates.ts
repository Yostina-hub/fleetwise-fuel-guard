...
export const deviceTemplates: DeviceTemplate[] = [
  ...
  },
  {
    ...
    type: "gps",
    vendor: "Queclink",
    description: "Rugged IP67 waterproof tracker with RS-485 fuel sensor support — Ideal for harsh Ethiopian conditions",
    icon: "🛡️",
    features: ["GPS", "4G LTE", "IP67 Waterproof", "RS-485 (Fuel Sensor)", "1-Wire", "4x Digital In", "1x Digital Out", "2x Analog In", "Driver ID (RFID/iButton)", "Harsh Driving", "Towing Detection", "Crash Detection"],
    parameters: ["GPS Position", "Speed", "Heading", "Altitude", "Satellites", "HDOP", "Fuel Level % (RS-485)", "Fuel Liters", "Temp Sensor 1-3", "Ignition", "Battery V", "External V", "GSM Signal", "Odometer", "Engine Hours", "Harsh Acceleration", "Harsh Braking", "Harsh Cornering", "Driver RFID", "Crash Event", "Tow Alert"],
    protocol: "queclink",
    defaultPort: 5030,
    popular: true,
  },
  {
    ...
    type: "gps",
    vendor: "Queclink",
    description: "Advanced multi-interface tracker with CAN bus + RS-485 fuel sensor — Premium Ethiopian fleet solution",
    icon: "🏆",
    features: ["GPS", "4G LTE", "IP67", "CAN Bus / J1939", "RS-485 (Fuel Sensor)", "1-Wire", "BLE 5.0", "6x Digital In", "2x Digital Out", "3x Analog In", "RFID", "Eco Driving", "Crash Detection"],
    parameters: ["GPS Position", "Speed", "Heading", "Altitude", "Fuel Level % (RS-485)", "Fuel Liters", "Fuel Consumption (CAN)", "Temp 1-4", "Engine RPM", "Coolant Temp", "Engine Hours", "Odometer (CAN)", "Throttle %", "Driver RFID", "BLE Sensors", "Harsh Events", "Crash G-Force", "Ignition", "Battery V", "External V", "DTC Codes"],
    protocol: "queclink",
    defaultPort: 5030,
    popular: true,
  },
  ...
  },
  {
    ...
    type: "gps",
    vendor: "Coban",
    description: "Fuel monitoring GPS tracker with cut-off relay - Popular in Ethiopian fleets",
    icon: "⛽",
    features: ["GPS", "Fuel Monitoring", "Remote Cut-off", "SOS", "Geo-fence", "ACC Detection", "Voice Monitoring", "Overspeed Alert"],
    parameters: ["GPS Location", "Speed (km/h)", "Fuel Level", "Battery Status", "GSM Signal", "ACC Status", "Relay Status", "SOS Status", "Movement Alert"],
    protocol: "tk103",
    defaultPort: 5013,
    popular: true,
  },
