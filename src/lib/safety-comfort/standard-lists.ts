...
const GROUP_ONE: VehicleGroupStandard = {
  ...
  items: [
    ...
    { key: "leather_seat_cover_prepared", label: "Leather Seat Cover (Prepared) — CXO", category: "vehicle_comfort_materials" },
    ...
    { key: "dash_board_cream",         label: "Dashboard Cream",                      category: "vehicle_comfort_materials" },
    { key: "car_perfume",              label: "Car Perfume",                          category: "vehicle_comfort_materials" },
    { key: "leather_sheet_cleaning",   label: "Leather Sheet for Cleaning",           category: "vehicle_comfort_materials" },
    ...
    { key: "glass_sticker",            label: "Glass Sticker",                        category: "vehicle_comfort_materials" },
